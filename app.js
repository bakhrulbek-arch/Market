...
let btn_slice = document.querySelector('.btn_slice')
let show_all = document.querySelector('.show_all')

btn_slice.onclick = () => {
    let slc = arr.slice(0, 5)
...
let open_bask = document.querySelector('.open_bask')

open_bask.onclick = () => {
    if (bask.classList.contains('bask_act')) {
        bask.classList.remove('bask_act')
        open_bask.innerHTML = 'Корзина'
    } else {
        bask.classList.add('bask_act')
        open_bask.innerHTML = 'Закрыть'
    }
}
